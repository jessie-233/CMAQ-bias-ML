...
# NO2_Obs SO2_Obs O3_Obs             RH_Obs TEM_Obs WDIR_Obs  WSPD_Obs PRE_Obs PBLH_Sim SOLRAD_Sim
var_sele = ['PM2.5_Bias_ystd','PM2.5_Sim','NO2_Bias','PRE_Bias','WSPD_Bias','PRE_Obs']
# ,'NO2_Bias','RH_Bias','SO2_Bias','WSPD_Bias','NO2_Obs','TEM_Obs','RH_Obs']
...
# plt.savefig("D:/project/data/BTH/TEMPORAL_TRANS/DNN_Model_Loss.png")
# plt.subplot(1, 2, 2)
...
# model.save("D:/project/data/BTH/TEMPORAL_TRANS/DNN_model.h5")