...
np.random.seed(317)
tf.random.set_seed(913)
data = np.load("D:/project/data/YRD/dataset_YRD.npy") #(61, 363, 43)
dataset_all = data.reshape((-1,43)) #(22143, 43)

train_data = np.concatenate((data[:,0:20,:],data[:,29:49,:],data[:,57:77,:],data[:,88:108,:],data[:,118:138,:],data[:,149:169,:],data[:,179:199,:],data[:,210:230,:],data[:,241:261,:],data[:,271:291,:],data[:,302:322,:],data[:,332:352,:]),axis=1).reshape((-1,43)) #(14640, 43) first 20 days of each month
test_data = np.concatenate((data[:,20:29,:],data[:,49:57,:],data[:,77:88,:],data[:,108:118,:],data[:,138:149,:],data[:,169:179,:],data[:,199:210,:],data[:,230:241,:],data[:,261:271,:],data[:,291:302,:],data[:,322:332,:],data[:,352:363,:]),axis=1).reshape((-1,43)) #(7503, 43) last 10 days of each month
...
X_all = scaler1.transform(X_all) #(22143, 19)
Y_all = scaler2.transform(Y_all) #(22143, 1)
...
plt.savefig("D:/project/data/YRD/final_allvar/seed1/DNN_YRD_1_Loss.png")
# plt.subplot(1, 2, 2)
...
model.save("D:/project/data/YRD/final_allvar/seed1/DNN_YRD_1.h5")