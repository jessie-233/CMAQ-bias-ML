...
DNN_model = load_model("D:/project/data/BTH/final_allvar/seed3/DNN_BTH_3.h5")
...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/final_allvar/seed3/contribution_analysis_temp.xlsx")
