...
DNN_model = load_model("D:/project/data/BTH/final_allvar/seed5/DNN_BTH_5.h5")
...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/final_allvar/seed5/contribution_analysis_temp.xlsx")
