...
plt.savefig("D:/project/data/BTH/final_allvar/seed5/DNN_BTH_5_Loss.png")
# plt.subplot(1, 2, 2)
...
model.save("D:/project/data/BTH/final_allvar/seed5/DNN_BTH_5.h5")