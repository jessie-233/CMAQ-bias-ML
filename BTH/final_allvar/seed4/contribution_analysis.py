...
DNN_model = load_model("D:/project/data/BTH/final_allvar/seed4/DNN_BTH_4.h5")
...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/final_allvar/seed4/contribution_analysis_temp.xlsx")
