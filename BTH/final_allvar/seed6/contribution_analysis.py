...
DNN_model = load_model("D:/project/data/BTH/final_allvar/seed6/DNN_BTH_6.h5")
...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/final_allvar/seed6/contribution_analysis_temp.xlsx")
