...
print(data.shape) #(61, 363, 43)
data = np.around(data, 2) #都保留2位小数
np.save("D:/project/data/BTH/DOMAIN_TRANS/YRD/dataset_YRD.npy", data)
