...
dataset_all = data_YRD.reshape((-1,43)) #(38115, 43)

test_data = np.concatenate((data_YRD[:,20:29,:],data_YRD[:,49:57,:],data_YRD[:,77:88,:],data_YRD[:,108:118,:],data_YRD[:,138:149,:],data_YRD[:,169:179,:],data_YRD[:,199:210,:],data_YRD[:,230:241,:],data_YRD[:,261:271,:],data_YRD[:,291:302,:],data_YRD[:,322:332,:],data_YRD[:,352:363,:]),axis=1).reshape((-1,43)) #(12915, 43)
