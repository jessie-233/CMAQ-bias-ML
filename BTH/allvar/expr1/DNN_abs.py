...
file = np.load("D:/project/data/BTH/new/dataset_abs_corr2.npy") #(44,363,42)
...
plt.savefig("D:/project/data/BTH/new/DNN_Model2_Loss.png")
# plt.subplot(1, 2, 2)
...
model.save("D:/project/data/BTH/new/DNN_model2.h5")