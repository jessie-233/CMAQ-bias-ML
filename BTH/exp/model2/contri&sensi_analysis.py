...
contribution_data = np.load("D:/project/data/BTH/exp/model2/contribution_result_YRD.npy") #(100, 363, 19) 62、97都是nan，其余都有值
sensitivity_data = np.load("D:/project/data/BTH/exp/model2/sensitivity_result_YRD.npy") #(100, 363, 19) 62、97都是nan，其余个别有nan
...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/exp/model2/model2_YRD.xlsx")
YRD_contribution_detail_pd.to_excel(writer,'YRD_contribution_detail',float_format='%.1f')
YRD_sensitivity_detail_pd.to_excel(writer,'YRD_sensitivity_detail',float_format='%.1f')
YRD_contribution_combine_pd.to_excel(writer,'YRD_contribution_combine',float_format='%.1f')
YRD_sensitivity_combine_pd.to_excel(writer,'YRD_sensitivity_combine',float_format='%.1f')
writer.close()
