...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/lessvar/expr3/sensitivity_analysis_temp.xlsx")
...
#datasetX_bj[156,:]，[[ 0.96  2.67 -0.1   0.75  0.94  0.13 -0.68  0.78 -0.94]]，从0.01往上加，至0.57有值，倒数第2个变量贡献度100%
# Check(datasetX_tj,64,0.57)


#datasetX_bj[156,:]，[[ 1.4   0.06 -0.15  0.5  -0.42  0.76 -0.18  1.56 -0.74]]，从0.01往上加，至1.3有值，倒数第3个变量贡献度100%
# Check(datasetX_tj,73,1.3)

#datasetX_bj[156,:]，[[ 1.69  1.21  1.06  0.5   0.52  0.93  0.69 -0.96  0.96]]，从0.01往上加，至0.8有值，倒数第1个变量贡献度100%
# Check(datasetX_tj,189,0.8)

#datasetX_bj[156,:]，[[ 1.85  2.25  0.49 -0.3  -0.87  0.85  0.08  1.    0.87]]，从0.01往上加，至4有值，倒数第3个变量贡献度100%
# Check(datasetX_tj,286,4)


#datasetX_bj[156,:]，[[ 0.77  2.71  0.18  0.55 -0.9   0.43 -0.29  0.72  1.02]]，从0.01往上加，至2有值，倒数第3个变量贡献度100%
# Check(datasetX_tj,287,2)

#datasetX_hb[133,:]，[[ 1.44  1.86 -0.09  1.14  1.29  0.59 -0.5   0.27 -0.79]]，从0.01往上加，至2.35有值，倒数第3个变量贡献度100%
# Check(datasetX_tj,290,2.35)

#datasetX_hb[133,:]，[[ 2.44 -0.07 -0.07  1.12  0.54  0.22  0.96 -0.08 -0.83]]，从0.01往上加，至0.8有值，倒数第3个变量贡献度100%
# Check(datasetX_tj,291,0.8)

#datasetX_hb[161,:]，[[ 1.1   4.22  2.04  1.19 -0.41  2.05  0.03  1.06 -1.3 ]]，从0.01往上加，至3有值，倒数第2个变量贡献度100%
# Check(datasetX_tj,314,3)

#datasetX_hb[161,:]，[[ 2.84  1.96  0.29  0.78  0.58  0.27 -0.21  1.08 -0.96]]，从0.01往上加，至4.9有值，倒数第2个变量贡献度100%
# Check(datasetX_tj,315,4.9)

#datasetX_hb[161,:]，[[ 0.84  1.52  0.99 -0.12  0.32  1.91 -0.3   0.12 -1.4 ]]，从0.01往上加，至0.72有值，倒数第2个变量贡献度100%
# Check(datasetX_tj,338,0.72)


#datasetX_hb[161,:]，[[ 1.77  3.08  1.41 -0.12 -0.04  2.09 -0.41  0.77 -1.47]]，从0.01往上加，至4有值，倒数第2个变量贡献度100%
# Check(datasetX_tj,339,4)

#datasetX_hb[161,:]，[[ 1.06  3.45  0.94  0.6   0.02  1.85 -0.29  1.02 -1.47]]，从0.01往上加，至0.26有值，倒数第3个变量贡献度100%
# Check(datasetX_tj,340,0.26)

#datasetX_hb[161,:]，[[ 1.06  3.45  0.94  0.6   0.02  1.85 -0.29  1.02 -1.47]]，从0.01往上加，至0.2有值，倒数第3个变量贡献度100%
# Check(datasetX_hb,289,0.2)

#datasetX_hb[161,:]，[[ 1.06  3.45  0.94  0.6   0.02  1.85 -0.29  1.02 -1.47]]，从0.01往上加，至0.2有值，倒数第3个变量贡献度100%
# Check(datasetX_hb,290,0.2)
