...
DNN_model = load_model("D:/project/data/BTH/lessvar/expr4/DNN_model4.h5")
...
#写入excel
writer = pd.ExcelWriter("D:/project/data/BTH/lessvar/expr4/contribution_analysis_temp.xlsx")
