...
for seed in seeds:
    ...
    for m in mete_bias:
        ...
        var_sele = ['PM2.5_Bias_ystd','PM2.5_Sim','NO2_Bias',m]
...
writer = pd.ExcelWriter('D:/project/data/BTH/lessvar/feature_selection/result_temp.xlsx')
# book = load_workbook('D:/project/data/BTH/lessvar/feature_selection/result.xlsx')
# writer.book = book
result_df = pd.DataFrame(result)
result_df.to_excel(writer,float_format='%.3f')
writer.close()
