...
train_data = np.concatenate((data[:,0:20,:],data[:,29:49,:],data[:,57:77,:],data[:,88:108,:],data[:,118:138,:],data[:,149:169,:],data[:,179:199,:],data[:,210:230,:],data[:,241:261,:],data[:,271:291,:],data[:,302:322,:],data[:,332:352,:]),axis=1).reshape((-1,43)) #(25200, 43)

test_data = np.concatenate((data[:,20:29,:],data[:,49:57,:],data[:,77:88,:],data[:,108:118,:],data[:,138:149,:],data[:,169:179,:],data[:,199:210,:],data[:,230:241,:],data[:,261:271,:],data[:,291:302,:],data[:,322:332,:],data[:,352:363,:]),axis=1).reshape((-1,43)) #(12915, 43)

dataset_all = data.reshape((-1,43)) #(38115, 43)
...
plt.savefig("D:/project/data/together/final_allvar/seed2/DNN_tog_2_Loss.png")
# plt.subplot(1, 2, 2)
...
model.save("D:/project/data/together/final_allvar/seed2/DNN_tog_2.h5")