...
for seed in seeds:
    ...
    for p in pol_bias:
        ...
        for m in mete_bias:
            ...
            row += 1
        col += 1
    writer = pd.ExcelWriter('D:/project/data/together/feature/result_temp.xlsx',engine='openpyxl')
    book = load_workbook('D:/project/data/together/feature/result_temp.xlsx')
    writer.book = book
