...
data_YRD = np.load("D:/project/data/YRD/dataset_YRD.npy") #(44,363,43)
...
plt.savefig("D:/project/data/BTH/DOMAIN_TRANS/YRD/model_for_YRD/DNN_YRD_Loss.png")
# plt.subplot(1, 2, 2)
...
model.save("D:/project/data/BTH/DOMAIN_TRANS/YRD/model_for_YRD/DNN_YRD.h5")
