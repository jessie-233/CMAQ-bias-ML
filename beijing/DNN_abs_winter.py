...
np.random.shuffle(dataset_winter) #(365,25)
# 数据集制作
...
X_train, y_train, X_test, y_test = split_dataset(datasetX_winter, datasetY_winter)
#print(X_train.shape, y_train.shape, X_test.shape, y_test.shape)
#(72, 20) (72, 1) (19, 20) (19, 1)
...
model.save("E:/project/beijing/DNN_abs_winter_model.h5")
