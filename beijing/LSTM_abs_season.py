...
X_train,y_train=datasetX[0:80,:],datasetY[0:80] 
X_test,y_test=datasetX[270:365,:],datasetY[270:365]
...
EPOCHS = 1000
history = model.fit(X_train, y_train, epochs=EPOCHS, batch_size=5, validation_split = 0.25, callbacks=[early_stopping], shuffle=False)
